...
{
    public static Vector3 RandomPointBetweenGameObjects(GameObject vertex1, GameObject vertex2)
    {
        Vector3 pos1 = vertex1.transform.position;
        Vector3 pos2 = vertex2.transform.position;
        return RandomPointBetweenVectors(pos1, pos2);
    }
    public static Vector3 RandomPointBetweenVectors(Vector3 vertex1, Vector3 vertex2)
    {
